/**
 * Shared types and runtime validators for the STS audit pipeline.
...
export interface SuggestedFix {
  file: "market-catalog.ts" | "sts-normalizer.ts" | "sts-outcome-map";
  change_type:
    | "add_id_mapping"
    | "add_name_pattern"
    | "add_outcome_map_entry"
    | "add_code_entry"
    | "change_view_type"
    | "add_selection_code"
...
const VALID_FIX_FILES = ["market-catalog.ts", "sts-normalizer.ts", "sts-outcome-map"] as const;
