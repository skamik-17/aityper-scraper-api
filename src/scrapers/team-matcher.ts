...
/**
 * Explicit aliases for known abbreviations (bookmaker → TheSportsDB canonical)
 * These are checked first before fuzzy matching
 *
 * IMPORTANT: Values must match TheSportsDB API names exactly
 * TheSportsDB uses English city names: Warsaw, Krakow, Lodz, etc.
 */
const TEAM_ALIASES: Record<string, string> = {
  ...
  "Arka G.": "Arka Gdynia",
  Arka: "Arka Gdynia",
  // Cracovia → Cracovia Krakow (TheSportsDB uses Krakow suffix)
